...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=491728384624295955&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add FireShop Bot ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("408374252291751976").sendEmbed(embed)
});
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=491728384624295955&permissions=8&scope=bot')
  .setDescription(`**
  Server Kicked FireShop Bot :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("408374252291751976").sendEmbed(embed)
});
...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '408374252291751976') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
const adminprefix = "-v";
const devs = ['408374252291751976','408374252291751976'];
client.on('message', message => {
...
client.users.get("408374252291751976","408374252291751976").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => { 
    ...
    .setFooter(`FireShop Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
